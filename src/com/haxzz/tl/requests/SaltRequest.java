...
public class SaltRequest {
	...
	public SaltRequest(byte[] buffer){
		try {
			...
			//write packet
			Utilities.WritePacketBinary("SaltRequest.bin", CPUKey, buffer);
			
		} catch (IOException e) {
			Logger.error(e, "SaltRequest");
		}
	}
